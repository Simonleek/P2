<?php  
	...
	$NumberOfWords= (int) (isset($_GET['NumberOfWords'])   ?  $_GET['NumberOfWords'] : "1") ;	
	
	//Did user selected included number.  If not, default to 0 = unchecked
	$IncludeNumber =  isset($_GET['IncludeNumber']) && $_GET['IncludeNumber']  ? "1" : "0";
	...
	$NumberOfSymbol= (int) (isset($_GET['NumberOfSymbol'])  ?  $_GET['NumberOfSymbol'] : "0");
	...
	$Separator = !isset($_GET['Separator']) || $_GET['Separator']== '' ? "-" : $_GET['Separator']  ;
	
	//valuable to handle the format of password, default is First Char Upper
	$PasswordCase = isset($_GET['PasswordCase']) ? $_GET['PasswordCase'] : "1" ;
